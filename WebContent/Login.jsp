...
pageEncoding="utf-8" import="com.zzy.user.User"%>
		...
		<div class="content">
			...
			<div class="login_box">	
				...
				<div class="login_form">
					...
					<form action="/Blog/Servlet/LoginCtrl" method="post">
						...
						<div class="form_check_ipt">
							<div class="left check_left">
								<label><input name="autologin" type="checkbox"> 7天内自动登录</label>
							</div>
						...
						<div class="form_reg_btn" style="padding:10px" >
							<span>还没有帐号？</span><a href="/Blog/register.jsp">马上注册</a>
						</div>
					</form>
				</div>
			</div>
